...
- [ ] **TODO-179**: **Authoritative SEO Article: Best Kidney Doctors (Nephrologists) in Feni (ফেনীর সেরা কিডনি বিশেষজ্ঞ ডাক্তার ও ডায়ালাইসিস ২০২৬)**
  - **Severity**: Medium (P1 - Chronic Disease Search Traffic)
  - **Files**: `src/data/blog/posts/bestKidneyDoctorsInFeni.ts`, `src/data/blog/blogPosts.ts`, `src/app/sitemap.ts`
  - **Details**: Publish a comprehensive guide for "ফেনীর সেরা কিডনি বিশেষজ্ঞ ডাক্তার ও ডায়ালাইসিস সেন্টার (Best Kidney Doctors & Dialysis Centers in Feni 2026)" under `/blog/best-kidney-doctors-in-feni`. Feature nephrologists and urologists (FCPS, MD Nephrology), kidney stone removal, dialysis unit costs at Feni Sadar Hospital and private facilities, creatinine management, diabetic nephropathy care, and serial booking details.

- [ ] **TODO-180**: **Cross-Linking Mesh, Category Filter Expansion & Rich Snippets for Feni Blog Cluster**
  - **Severity**: Medium (P1 - SEO Clustering & Link Equity)
  - **Files**: `src/data/blog/blogPosts.ts`, `src/app/blog/page.tsx`, `src/components/landing/LandingBlogSection.tsx`, `src/app/sitemap.ts`
  - **Details**: Interlink the entire Feni medical blog cluster (Hospitals -> Doctors -> Diagnostics -> Dental -> Physio -> Gynecologist -> Cardiologist -> Nephrologist) with contextual internal links, anchor texts, and related guide cards. Expand category filter pills on `/blog` to include "ডাক্তার তালিকা", "ডায়াগনস্টিক", "ডেন্টাল ও ফিজিও", and "বিশেষায়িত চিকিৎসা". Verify sitemap priority updates (0.9) and Schema.org rich snippets for maximum Google indexation.
