...
- [ ] **TODO-224**: **Add `select` Clauses to Member Login & Auth Queries to Exclude Heavy Fields**
  - **Priority**: Medium (P1 - Reduces Auth Egress by ~10-20MB/day)
  - **Files**: `src/app/actions/memberAuthActions.ts`, `src/app/actions/partnerAuthActions.ts`
