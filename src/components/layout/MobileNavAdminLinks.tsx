        ...
        <div className="space-y-1 pl-1">
          ...
          >
            ...
            {pendingRenewals > 0 && (
              <span className="text-[10px] font-mono px-2 py-0.5 rounded-full font-bold bg-amber-500/20 text-amber-700 dark:text-amber-300 border border-amber-500/30">
                {toBanglaNums(pendingRenewals)} পেন্ডিং
              </span>
            )}
          </Link>
          ...
          >
            <div className="flex items-center gap-2.5">
              ...
              <span>আর্থিক ও রাজস্ব অ্যানালিটিক্স</span>
            </div>
          </Link>
        </div>
      </div>
        ...
        <div className="space-y-1 pl-1">
          ...
          >
            <div className="flex items-center gap-2.5">
              ...
              <span>ডায়াগনস্টিক সেন্টার</span>
            </div>
          </Link>
          ...
          >
            <div className="flex items-center gap-2.5">
              ...
              <span>অংশীদার আবেদন</span>
            </div>
            {pendingPartnerRequests > 0 && (
              <span className="text-[10px] font-mono px-2 py-0.5 rounded-full font-bold bg-amber-500/20 text-amber-700 dark:text-amber-300 border border-amber-500/30">
                {toBanglaNums(pendingPartnerRequests)} পেন্ডিং
              </span>
            )}
          </Link>
        </div>
        ...
        <div className="space-y-1 pl-1">
          ...
          >
            <div className="flex items-center gap-2.5">
              ...
              <span>ব্রডকাস্ট ক্যাম্পেইন</span>
            </div>
          </Link>
          ...
          >
            <div className="flex items-center gap-2.5">
              ...
              <span>বিজ্ঞপ্তি ও অ্যালার্ট</span>
            </div>
          </Link>
          ...
          >
            ...
            {contactMessagesCount > 0 && (
              <span className="text-[10px] font-mono px-2 py-0.5 rounded-full font-bold bg-primary/15 text-primary border border-primary/20">
                {toBanglaNums(contactMessagesCount)}
              </span>
            )}
          </Link>
      ...
      <div className="pt-2 border-t border-border/60">
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <span>পাবলিক ওয়েবসাইট দেখুন</span>
          </div>
