    ...
    <Card className="border border-border shadow-xs">
      <CardHeader className="pb-3">
        ...
        <CardDescription className="text-xs">
          {"সাইটের ফুটার ও কন্টাক্ট সেকশনের তথ্য"}
        </CardDescription>
      </CardHeader>
        ...
        <div className="pt-2 border-t border-border/60">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div className="space-y-1.5">
              ...
              <Input
                id="facebook-url"
                placeholder={"যেমন: https://facebook.com/healthclub"}
            ...
            <div className="space-y-1.5">
              ...
              <Input
                id="youtube-url"
                placeholder={"যেমন: https://youtube.com/@healthclub"}
            ...
            <div className="space-y-1.5">
              <Label htmlFor="instagram-url" className="text-xs font-semibold">
                {"ইনস্টাগ্রাম প্রোফাইল লিংক"}
              </Label>
              <Input
                id="instagram-url"
                placeholder={"যেমন: https://instagram.com/healthclub"}
            ...
            <div className="space-y-1.5">
              <Label htmlFor="x-url" className="text-xs font-semibold">
                {"X (টুইটার) প্রোফাইল লিংক"}
              </Label>
              <Input
                id="x-url"
                placeholder={"যেমন: https://x.com/healthclub"}
                {...register("x_url")}
              />
              {errors?.x_url && (
            ...
            <div className="space-y-1.5 sm:col-span-2">
              ...
              <Input
                id="linkedin-url"
                placeholder={"যেমন: https://linkedin.com/company/healthclub"}
