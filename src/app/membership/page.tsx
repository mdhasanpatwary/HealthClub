...
export default async function MembershipPage() {
  ...
  const benefitDetails = locale === "en" ? [
    { title: "Hospital Discount", desc: "Flat 10% discount on the total bill at any partner hospital simply by showing your digital membership card.", gradient: "from-emerald-500 to-green-600" },
    { title: "Diagnostic Test Off", desc: "Flat 10% discount on all pathological and imaging tests including blood tests and X-rays.", gradient: "from-blue-500 to-cyan-600" },
    { title: "Model Pharmacy Offer", desc: "Flat 10% direct discount on purchasing essential medicines from designated partner pharmacies.", gradient: "from-violet-500 to-purple-600" },
