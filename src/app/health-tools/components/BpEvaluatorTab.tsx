...
export function BpEvaluatorTab() {
  ...
  const handleEvaluate = (e: React.FormEvent) => {
    ...
    if (isNaN(sys) || isNaN(dia)) {
      toast.error("অনুগ্রহ করে সিস্টোলিক এবং ডায়াস্টোলিক রক্তচাপের সঠিক মান প্রদান করুন।");
      return;
    }

    if (sys < 50 || sys > 260) {
      toast.error("সিস্টোলিক রক্তচাপ সাধারণত ৫০ থেকে ২৬০ mmHg এর মধ্যে হয়ে থাকে।");
      return;
    }

    if (dia < 30 || dia > 180) {
      toast.error("ডায়াস্টোলিক রক্তচাপ সাধারণত ৩০ থেকে ১৮০ mmHg এর মধ্যে হয়ে থাকে।");
      return;
    }

    if (sys <= dia) {
      toast.error("সিস্টোলিক রক্তচাপ অবশ্যই ডায়াস্টোলিক রক্তচাপের চেয়ে বেশি হতে হবে।");
      return;
    }
    ...
    toast.success("রক্তচাপের মূল্যায়ন সম্পন্ন হয়েছে!");
  };
        ...
        <CardContent className="p-5 sm:p-7 space-y-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-heading font-bold text-base sm:text-lg text-secondary dark:text-white">
                রক্তচাপ মূল্যায়ন (BP Evaluator)
              </h3>
              <p className="text-xs text-muted-foreground">
                আন্তর্জাতিক হৃদরোগ গাইডলাইন অনুযায়ী শ্রেণীবিভাগ
              </p>
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="flex flex-wrap gap-1.5">
              ...
              <Button
                ...
                variant="outline"
                size="sm"
                className="text-[11px] h-7 px-2.5 rounded-lg border-amber-500/30 hover:bg-amber-500/10 cursor-pointer"
              ...
              <Button
                ...
                variant="outline"
                size="sm"
                className="text-[11px] h-7 px-2.5 rounded-lg border-rose-600/30 hover:bg-rose-600/10 cursor-pointer"
          ...
          <form onSubmit={handleEvaluate} className="space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <p className="text-[11px] text-muted-foreground">
                হৃৎপিণ্ডের সংকোচনকালীন চাপ (আদর্শ: ১২০ এর নিচে)
              </p>
            </div>
            ...
            <div className="space-y-1.5">
              <div className="flex items-center justify-between">
                <Label htmlFor="bp-diastolic" className="text-xs font-bold text-secondary dark:text-white">
                  ডায়াস্টোলিক রক্তচাপ (নিচের সংখ্যা)
                </Label>
                <span className="text-[11px] font-mono text-muted-foreground">mmHg</span>
              </div>
              <Input
              ...
              />
              <p className="text-[11px] text-muted-foreground">
                হৃৎপিণ্ডের প্রসারণকালীন চাপ (আদর্শ: ৮০ এর নিচে)
              </p>
            </div>
            ...
            <div className="flex items-center gap-3 pt-2">
              ...
              >
                ...
                <span>রক্তচাপ মূল্যায়ন করুন</span>
              </Button>
              <Button
                type="button"
                variant="outline"
          ...
          <div className="p-4 rounded-2xl bg-muted/50 border border-border/60 text-xs space-y-2">
            <div className="font-semibold text-secondary dark:text-white flex items-center gap-1.5">
              ...
              <span>আদর্শ রক্তচাপের আন্তর্জাতিক রেফারেন্স:</span>
            </div>
            <div className="grid grid-cols-2 gap-1.5 text-[11px] text-muted-foreground">
              <div>🟢 স্বাভাবিক: &lt;120 / &lt;80</div>
              <div>🟡 উত্তোলিত: 120-129 / &lt;80</div>
              <div>🟠 স্টেজ ১: 130-139 / 80-89</div>
              <div>🔴 স্টেজ ২: ≥140 / ≥90</div>
            </div>
          </div>
        </CardContent>
      </Card>
