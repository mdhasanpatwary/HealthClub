...
export default function AdminLoginPage() {
  ...
  const handleAdminLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.error(res?.message || "ভুল মোবাইল নম্বর/ইমেইল অথবা পাসওয়ার্ড। অনুগ্রহ করে আবার চেষ্টা করুন।");
    } catch {
    ...
    <div className="bg-muted/30 min-h-[80vh] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <Card className="w-full max-w-md border border-border shadow-xl bg-background/80 backdrop-blur">
        <CardHeader className="text-center space-y-2">
          ...
          <CardDescription>
            সদস্য ও সিস্টেম পরিচালনার জন্য এডমিন ক্রেডেনশিয়াল দিয়ে লগইন করুন।
          </CardDescription>
        </CardHeader>
