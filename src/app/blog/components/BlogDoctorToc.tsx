    ...
    <ol className="space-y-1.5 list-none pl-0">
      ...
      <li>
        <a href="#selection-guide" className={linkClass("selection-guide")}>
          ...
          {isEn ? "Guidelines for Choosing Specialist/Clinic" : "সঠিক ডাক্তার ও ক্লিনিক নির্বাচনের উপায়"}
        </a>
      </li>
      <li>
        <a href="#emergency-directory" className={linkClass("emergency-directory")}>
          {secNum(hasDoctorPricing ? 7 : 6)}
          {isEn ? "Emergency Contacts & Helpline" : "জরুরি যোগাযোগ ও হটলাইন"}
        </a>
      </li>
      <li>
        <a href="#faq-section" className={linkClass("faq-section")}>
          {secNum(hasDoctorPricing ? 8 : 7)}
